...
import { CONTRACT_ADDRESS, CONTRAACT_ABI } from './CONTRACT';

import { ConnectButton } from "@rainbow-me/rainbowkit";
import { useAccount, useContract} from 'wagmi';
import { useSigner } from '@rainbow-me/rainbow-kit/wagmi';
              ...
              <h1 className="text-4xl font-extrabold">Vote</h1>
              {
                address ? (
                  <div className='flex flex-row gap-4 items-center justify-center'>
                    ...
                    className='bg-blue-500 text-white px-4 py-2 rounded-lg'>Add Candidate</button>
                    <button 
